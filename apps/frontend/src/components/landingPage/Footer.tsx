        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center sm:pl-8 sm:pr-8">
          ...
          <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
            ...
            <p className="text-lg sm:text-md font-semibold w-full sm:w-2/3">
              HobbyHive connects enthusiasts, fostering communities and sharing passions through
              tailored experiences, interactive groups, and collaboration.
            </p>
          </div>
          ...
          <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
            ...
            <ul className="text-md space-y-2">
              <li>
                <a href="#" className="short-underline font-semibold">
                  Home
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-1/3">
            ...
            <p className="text-md font-semibold">
              Email:{" "}
              <a href="mailto:info@company.com" className="short-underline text-md font-semibold">
