...
function About() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-4xl md:text-7xl text-left font-bnt block">WHAT IS HOBBYHIVE?</span>
        <p className="text-lg md:text-2xl mt-4 md:ml-2 md:mt-6 font-pop text-left">
          HobbyHive is the ultimate platform for hobby enthusiasts. From crafting to gaming, join
          communities tailored to your interests and connect with others who share your passion.
        </p>
      </motion.div>
